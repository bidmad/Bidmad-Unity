...
public static class BidmadPostProcessBuild {
        ...
        if(buildTarget == BuildTarget.iOS) {
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "5f5u5tfb26.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "6h82f75d2w.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "6lz2ygh3q6.adattributionkit");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "77y3x8wds4.adattributionkit");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "77y3x8wds4.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "87u5trcl3r.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "apzhy3va96.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "f2zub97jtl.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "fq6vru337s.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "g69uk9uh2b.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "g6gcrrvk4p.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "ln5gz23vtd.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "m2jqnlggk3.adattributionkit");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "ns5j362hk7.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "nzq8sh4pbs.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "p4ybsjem3u.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "p78axxw29g.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "pg7ctvrt6f.adattributionkit");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "raa6f494kr.adattributionkit");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "thzdn4h5nc.adattributionkit");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "tskbem2b5g.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "vhf287vqwu.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "x8yj322td6.skadnetwork");
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "xga6mpmplv.skadnetwork");
                ...
                skAdNetworkArray.AddDict().SetString("SKAdNetworkIdentifier", "z959bm4gru.skadnetwork");
